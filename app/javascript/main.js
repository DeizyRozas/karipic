...
(function($) {
	// Alternacion de inicio sesion y registro 
	document.addEventListener("DOMContentLoaded", function () {
		const registroForm = document.getElementById("registroForm");
		const inicioSesionForm = document.getElementById("inicioSesionForm");
		const alternarFormulariosBoton = document.getElementById("alternarFormularios");
		const volverARegistroBoton = document.getElementById("volverARegistro");

		alternarFormulariosBoton.addEventListener("click", function () {
			registroForm.style.display = "none";
			inicioSesionForm.style.display = "block";
		});

		volverARegistroBoton.addEventListener("click", function () {
